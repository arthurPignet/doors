"""Unit tests for :mod:`doors.core`."""

import pytest

from doors.core import dummy_function
...
def test_dummy_function(value, result):
    """Test main function of :func:`doors.core.dummy_function`."""
...
def test_dummy_function_wrong_input_type(value):
    """Test wrong input type to :func:`doors.core.dummy_function`."""
