...
package_distribution = pkg_resources.get_distribution('doors')

# General information about the project.
project = 'Deep dOppler brOadening cRoss Section'
copyright = f'{datetime.date.today().year}, arthurPignet'
...
latex_documents = [
    (master_doc, 'doors.tex', project, 'Arthur Pignet', 'manual'),
]
...
man_pages = [(master_doc, 'doors', project, [author], 1)]
...
html_theme_options = {
    "github_url": "https://github.com/arthurPignet/doors",
